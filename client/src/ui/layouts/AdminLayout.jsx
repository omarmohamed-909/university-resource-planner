...
const breadcrumbKeys = {
  ...
  '/admin/halls': 'sidebar.halls',
  '/admin/schedules': 'sidebar.schedules',
  '/admin/courses': 'sidebar.courses',
  '/admin/users': 'sidebar.users',
  '/admin/attendance': 'sidebar.attendance',
  '/admin/swaps': 'sidebar.swaps',
  '/admin/auto-schedule': 'sidebar.autoSchedule',
}
          ...
          <div className="flex items-center justify-between h-16 px-5 md:px-8">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="relative">
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center text-white font-bold text-sm shadow-sm ring-2 ring-surface">
