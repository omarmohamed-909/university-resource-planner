      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-canvas p-4">
          <div className="text-center max-w-md">
            ...
            <h2 className="text-2xl font-bold text-title mb-2">{i18n.t('errorBoundary.title')}</h2>
            <p className="text-body mb-2">{i18n.t('errorBoundary.description')}</p>
            {this.state.error && (
              <p className="text-xs text-muted mb-6 font-mono bg-surface p-3 rounded-lg text-right">
